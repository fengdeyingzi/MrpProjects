...
int32 math_init(void)
{
	Haninit(NULL);

	AddString( MathAcos,         "float acos(float);" );
	AddString( MathAsin,         "float asin(float);" );
	AddString( MathAtan,         "float atan(float);" );
	AddString( MathAtan2,        "float atan2(float, float);" );
	AddString( MathCeil,         "float ceil(float);" );
	AddString( MathCos,          "float cos(float);" );
	AddString( MathCosh,         "float cosh(float);" );
	AddString( MathExp,          "float exp(float);" );
	AddString( MathFabs,         "float fabs(float);" );
	AddString( MathFloor,        "float floor(float);" );
	AddString( MathFmod,         "float fmod(float, float);" );
	AddString( MathFrexp,        "float frexp(float, int *);" );
	AddString( MathLdexp,        "float ldexp(float, int);" );
	AddString( MathLog,          "float log(float);" );
	AddString( MathLog10,        "float log10(float);" );
	AddString( MathModf,         "float modf(float, float *);" );
	AddString( MathPow,          "float pow(float,float);" );
	AddString( MathRound,        "float round(float);" );
	AddString( MathSin,          "float sin(float);" );
	AddString( MathSinh,         "float sinh(float);" );
	AddString( MathSqrt,         "float sqrt(float);" );
	AddString( MathTan,          "float tan(float);" );
	AddString( MathTanh,         "float tanh(float);" );
	AddString( NULL,             NULL );
