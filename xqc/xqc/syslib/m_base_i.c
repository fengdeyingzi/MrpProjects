...
//{
//	strcmp(PLAT_EX_CBTEXT,(char *)Param[5]->Val->Pointer);
//	ReturnValue->Val->UnsignedInteger = mrc_platEx(Param[0]->Val->UnsignedInteger,Param[1]->Val->Pointer,Param[2]->Val->UnsignedInteger,Param[3]->Val->Pointer,Param[4]->Val->Pointer,Lib_PLAT_EX_CB);
//}
