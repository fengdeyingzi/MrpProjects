...
#define ELFMAG0         'M'            /* Magic number byte 0 */

#define EI_MAG1         1               /* File identification byte 1 index */
#define ELFMAG1         'R'             /* Magic number byte 1 */

#define EI_MAG2         2               /* File identification byte 2 index */
#define ELFMAG2         'P'             /* Magic number byte 2 */

#define EI_MAG3         3               /* File identification byte 3 index */
#define ELFMAG3         'G'             /* Magic number byte 3 */

/* Conglomeration of the identification bytes, for easy testing as a word.  */
#define ELFMAG          "\177ELF"
#define SELFMAG         4

#define EI_CLASS        4               /* 文件类字节索引*/
#define ELFCLASSNONE    0               /* 无效的 class */
...
#define ELFDATA2LSB     1               /* 2的补数,小端字节序 */
#define ELFDATA2MSB     2               /*2的补数,大端字节序 */
#define ELFDATANUM      3
