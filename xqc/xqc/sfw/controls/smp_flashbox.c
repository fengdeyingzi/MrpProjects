...
{
	const DWORD* frames; //bitmap frames
	Uint32 size; // the size of the frames array
	Uint32 interval; // the timer interval
	BOOL loop; // loop mode playing
	BOOL playing; // the timer is working
	int32 flash_timer; // the timer handle
	Uint32 cur; // current bitmap index in frames array
