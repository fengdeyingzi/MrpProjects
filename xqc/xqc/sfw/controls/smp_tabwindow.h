...
/**
 * \brief Indicates that right arrow pressed表示按下右箭头
 */
#define SMP_TABWNDS_RIGHTARROW			0x0001L

/**
 * \brief Indicates that left arrow pressed表示左键按下
 */
...
/**
 * \brief The tab window bar height简短的标签窗口栏的高度
 */
#define SMP_TABWND_TABBAR_HEIGHT		SMP_ITEM_HEIGHT

/**
 * \brief The max tab the tab window support简短的最大标签上的标签窗口支持
 */
 ...
 * \param bmp the icon id图标的ID
 * \param title the child tab window title\参数标题子窗口的标题
...
/**
 * \brief Remove all the tabs删除所有的标签
 *
 * \param hWnd the tab window handle参数的hWnd窗口句柄的标签
 */
