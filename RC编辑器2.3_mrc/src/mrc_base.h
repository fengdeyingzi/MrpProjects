...
enum {
   ...
   MR_OSD_EVENT,            	//11
   MR_MOUSE_MOVE,          //12	注意，只有很新的机型才支持该事件。
...
extern void *(*MR_MEMMOVE)(void * s1, const void * s2, int n);
 void MR_STRCPY(char * s1, const char * s2){}
void MR_STRNCPY(char * s1, const char * s2, int n){}
...
extern unsigned long int (*MR_STRTOUL)(const char * nptr, char ** endptr, int base);
 ...
 void* mrc_malloc(int size){void *a; return a;};
...
个字节开始才表示下一行的点阵数据*/
char *mrc_getCharBitmap(uint16 ch, uint16 fontSize, int *width, int *height){char *t;return t;}
...
NULL	            失败（注意，这里与其他接口不一样）
*/
int32 mrc_open(const char* filename,  uint32 mode){int32 a;return a;}
...
MR_FAILED	失败
*/
int32 mrc_close(int32 f){int32 a;return a;}
...
*/
int32 mrc_fileState(const char* filename){int32 a;return a;}
...
返回:
      ...
      MR_FAILED      失败
*/
int32 mrc_write(int32 f,void *p,uint32 l){int32 a;return a;}
...
返回:
      ...
      MR_FAILED      失败
*/
int32 mrc_read(int32 f,void *p,uint32 l){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_seek(int32 f, int32 pos, int method){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败/文件不存在
*/
int32 mrc_getLen(const char* filename){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_remove(const char* filename){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_rename(const char* oldname, const char* newname){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_mkDir(const char* name){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_rmDir(const char* name){int32 a;return a;}
...
返回:
      ...
      MR_FAILED      失败
*/
int32 mrc_findStart(const char* name, char* buffer, uint32 len){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   搜索结束或搜索失败
*/
int32 mrc_findGetNext(int32 search_handle, char* buffer, uint32 len){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_findStop(int32 search_handle){int32 a;return a;}
...
*/
int32 mrc_drawChar(uint8* chr, int16 x, int16 y, mr_screenRectSt rect, mr_colourSt colorst, uint16 font){int32 a;return a;}
...
返回值:
   ...
   MR_FAILED      操作失败
*/
int32 mrc_drawText(char* pcText, int16 x, int16 y, uint8 r, uint8 g, uint8 b, int is_unicode, uint16 font){int32 a;return a;}
...
*/
int32 mrc_drawTextEx(char* pcText, int16 x, int16 y, mr_screenRectSt rect, mr_colourSt colorst, int flag, uint16 font){int32 a;return a;}
...
*/
int32 mrc_drawTextLeft(char* pcText, int16 x, int16 y, mr_screenRectSt rect, mr_colourSt colorst, int flag, uint16 font){int32 a;return a;}
...
显示，则返回该字串转换为0。
*/
int32 mrc_drawTextRight(char* pcText, int16 x, int16 y, mr_screenRectSt rect, mr_colourSt colorst, int flag, uint16 font){int32 a;return a;}
...
返回:
    ...
    其他    Unicode字符串指针
*/
uint16* mrc_c2u(char *cp, int32 *err, int32 *size){uint16 *a;return a;}
...
*/
uint16* mrc_c2uVM(char *cp, int32 *err, int32 *size){uint16* a;return a;}
...
返回:
    ...
    MR_FAILED      操作失败
*/
int32 mrc_textWidthHeight(char* pcText, int is_unicode, uint16 font, int32* w, int32* h){int32 a;return a;}
...
返回:
    ...
    MR_FAILED      操作失败
*/
int32 mrc_unicodeTextWidthHeight(uint16* pcText, uint16 font, int32* w, int32* h){int32 a;return a;}
...
w                  待显示宽度
 返回:
    ...
    其他           字符串行数
*/
int32 mrc_unicodeTextRow(uint16* pcText, uint16 font, int32 w){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_getScreenInfo(mr_screeninfo * screeninfo){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_bitmapLoad(uint16 i, char* filename, int16 x, int16 y, uint16 w, uint16 h, uint16 max_w){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_bitmapShow(uint16 i, int16 x, int16 y, uint16 rop, int16 sx, int16 sy, int16 w, int16 h){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_spriteCheck(uint16 i, uint16 spriteindex, int16 x, int16 y,uint8 r, uint8 g, uint8 b){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_menuCreate(const char* title, int16 num){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_menuSetItem(int32 menu, const char *text, int32 index){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_menuRefresh(int32 menu){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_dialogRelease(int32 dialog){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_editCreate(const char * title, const char * text, int32 type, int32 max_size){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_editRelease(int32 edit){int32 a;return a;}
...
*/
int32 mrc_getHostByName(const char *name, MR_GET_HOST_CB cb){int32 a;return a;}
...
返回:
      ...
      MR_FAILED    失败
*/
int32 mrc_socket(int32 type, int32 protocol){int32 a;return a;}
...
返回:
      ...
      MR_WAITING   使用异步方式进行连接，应用需要轮询
                            该socket的状态以获知连接状况
*/
int32 mrc_connect(int32 s, int32 ip, uint16 port, int32 type){int32 a;return a;}
...
返回:
      ...
      MR_IGNORE  ：不支持该功能
*/
int32 mrc_getSocketState(int32 s){int32 a;return a;}
...
*/
int32 mrc_recv(int32 s, char *buf, int len){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   Socket已经被关闭或遇到了无法修复的错误。
*/
int32 mrc_recvfrom(int32 s, char *buf, int len, int32 *ip, uint16 *port){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   Socket已经被关闭或遇到了无法修复的错误。
*/
int32 mrc_send(int32 s, const char *buf, int len){int32 a;return a;}
...
返回:
      ...
      MR_FAILED     Socket已经被关闭或遇到了无法修复的错误。
*/
int32 mrc_sendto(int32 s, const char *buf, int len, int32 ip, uint16 port){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_soundSet(uint16 i, char * filename, int32 type){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mr_playSoundEx(int type, const void* data, uint32 dataLen, int32 loop){int32 a;return a;}
...
t           定时器句柄
*/
void mrc_timerStop (int32 t){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_timerSetTimeEx (int32 t, int32 time){int32 a;return a;}
...
返回:
     单位毫秒的系统时间
*/
int32 mrc_getUptime(void){int32 a;return a;}
...
返回:
      ...
      MR_FAILED   失败
*/
int32 mrc_getDatetime(mr_datetime* datetime){int32 a;return a;}
...
返回:
      系统所剩余的内存数，单位字节
*/
uint32 mrc_getMemoryRemain(void){int32 a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_startShake(int32 ms){int32 a;return a;}
...
返回:
      mythroad平台版本号
*/
int32 mrc_getVersion(void){int32 a;return a;}
...
返回:
      当前正在运行的mrp的文件名称
*/
char* mrc_getPackName(void){char* a;return a;}
...
返回:
      ...
      MR_FAILED         失败
*/
int32 mrc_setPackName(char * name){int32 a;return a;}

/*
取得系统的总共内存大小
*/
int32 mrc_getSysMem(void){int32 a;return a;}
...
int32 mrc_readFileFromMrpEx(char* packname, const char* filename, 
               uint8 ** filebuf, int32 *filelen, int32 lookfor){int32 a;return a;}
...
int32 mrc_readFileFromMrpExPart(char* packname, const char* filename, 
               uint8 ** filebuf, int32 *filelen, int32 offset, int32 read_len){int32 a;return a;}
...
*/
uint32 mrc_updcrc(uint8 *s, uint32 n){uint32 a;return a;}
...
/*
  初始化平台的Second Screen Buffer 扩展内存：
  返回：
        MR_SUCCESS   成功， 如果是MTK平台就肯定会成功。
        MR_FAILED    失败   非MTK平台失败。
*/
extern int32 mrc_exRamSSBInit(void);


/*
初始化平台的Screen Based Application Shared Memory 扩展内存；
返回:
      MR_SUCCESS   成功
      MR_FAILED       失败
*/
