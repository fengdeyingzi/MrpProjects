...
extern int32 mrc_appEvent(int32 code, int32 p0, int32 p1);
extern int32 mrc_appPause(void);
...
#define MRC_EXT_EVENT mrc_appEvent   
#define MRC_EXT_PAUSE mrc_appPause
#define MRC_EXT_RESUME mrc_appResume

#else

#define MRC_EXT_INIT mrc_init
#define MRC_EXT_EXIT mrc_exitApp
#define MRC_EXT_EVENT mrc_event   
#define MRC_EXT_PAUSE mrc_pause
#define MRC_EXT_RESUME mrc_resume
