...
#define strrcmp(s1, s2) mrc_strrcmp(s1, s2)
#define strlen(s) mrc_strlen(s)
#define wstrlen(s) mrc_wstrlen(s)
#define strcpy(s1, s2) mrc_strcpy(s1, s2)
#define strncat(s1, s2, n) mrc_strncat(s1, s2, n)
#define malloc(size) mrc_malloc(size)
#define free(p) mrc_free(p)
#define memcpy(s1, s2, n) mrc_memcpy(s1, s2, n)
#define memmove(s1, s2, n) mrc_memmove(s1, s2, n)
#define memset(s1, c, n) mrc_memset(s1, c, n)
